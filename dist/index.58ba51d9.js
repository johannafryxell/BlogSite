...
window.onload = function() {
    ...
    document.getElementById("blogHeading").addEventListener("click", ()=>{
        if (allBlogs.length != 0) location.href = "http://localhost:1234/pages/blogs.html";
    });
};
function displayBlogs() {
    if (allBlogs.length === 0) {
        ...
        let listedBlogs = document.createElement("ul");
        for(let i = 0; i < allBlogs.length; i++){
            let listedBlog = document.createElement("li");
...
function displayPosts() {
    if (allPosts.length === 0) {
        ...
        let documentWrapper = document.getElementById("postedPosts");
        documentWrapper.innerHTML = "";
        let listedPosts = document.createElement("ul");
        let printPosts;
        if (allPosts.length >= 5) printPosts = 5;
        else printPosts = allPosts.length;
...
function createPostForm() {
    if (allBlogs.length === 0) {
        ...
        let selectBlog = document.createElement("select");
...
function createBlog() {
    ...
    let inputBlog = document.getElementById("blogName");
    if (inputName.value === "" || inputBlog.value === "") alert("You need to write in the inputs");
    else {
        let newId = allBlogs.length + 1;
        let newBlog = new _blog.Blog(inputName.value, inputBlog.value, newId);
...
function createPost() {
    ...
    if (inputTitle.value === "" || inputText.value === "") alert("You need to write in the inputs");
    else {
        let newPost = new _post.Post(inputTitle.value, inputText.value, parseInt(dropDown.value));
        allPosts.push(newPost);
        localStorage.setItem("allPosts", JSON.stringify(allPosts));
    }
}

},{"./models/Blog":"eboSI","./models/Post":"7lbs5"}],"eboSI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Blog", ()=>Blog
);
class Blog {
    constructor(personName, blogName, id){
        this.id = id;
...
},{}],"7lbs5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Post", ()=>Post
);
class Post {
    constructor(title, postText, blogId){
        this.title = title;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["e4k7L","7BLcd"], "7BLcd", "parcelRequire12a1")
